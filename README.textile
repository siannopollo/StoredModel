...
To find a dog by name           => <pre style="display:inline">Dog *dog = [Dog findFirst: @"name = '% @%'", @"Spot"]</pre>
To find all dogs by name        => <pre style="display:inline">Dog *dog = [Dog find: @"name = '% @%'", @"Spot"]</pre>
